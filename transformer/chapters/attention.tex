...
\begin{frame}[c]{Basic Attention: Importance Weighing}
    ...
    \raisebox{3em}{\gray{Image Source: \cite{bahdanau_neural_2016}}}
    \pnote{
...
\begin{frame}[c]{GQA: Grouped Query Attention}
    \includegraphics[width=\textwidth]{gqa} \\
    \gray{Image Source: \cite{ainslie_gqa_2023}}
\end{frame}
