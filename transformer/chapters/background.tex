...
%     \begin{itemize}[<+(1)->]
%         \item Easy text: low perplexity
%         \item Hard / sophisticated text: high perplexity (particularly if not seen before)
%         \item lowest possible value from information theory perspective: probably around 1.6
%     \end{itemize}
%     \todo{build slide}
% \end{frame}
