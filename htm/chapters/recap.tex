...
\begin{frame}[c]{Neuron - Number of Synapses}
    \pause
    \vfill % some empty space here
    \begin{tabular}{ll}
        Min. n. of synapses \phantom{AAA} & 1'000 \\
        Avg. n. of synapses & 7'000 \\
        Max. n. of synapses & 10'000 \\ \\ \pause
    ...
    \vfill
    \small
    Connection data from \cite{herculano2009human} and firing rates from \cite{impact2015firing}.
\end{frame}
