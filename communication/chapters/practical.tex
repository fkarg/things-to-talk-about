...
\begin{frame}[c]{Feedback: Situation}
    ...
    \end{itemize}
    \pnote{Tell story for giving good feedback}
\end{frame}
...
% Next TODO: Slides zu gutes feedback geben, nicht vorwurfsvoll etc + übung dazu
...
\begin{frame}[c]{Übung: Die andere Seite verstehen}
    ...
    \pnote{Besser vorbereiten was genau bedingungen sind und wie explorativ}
    \pnote{nicht selbstverständlich: erst eigene Meinung explorieren}
    \pnote{Verantwortlichkeiten klar machen: man selbst ist voll für eigene Kommunikation verantwortlich!!! do that early on!}
    \pnote{How to Konfliktlösung}
    \pnote{Gruppenmediation}
\end{frame}
