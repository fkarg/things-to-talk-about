...
\begin{frame}[c]{Problem des Ordinalen Zahlenstrahls}
    ...
    \Huge
    \only<1> {
        \includegraphics[width=0.8\textwidth]{zahlenstrahl.jpeg}
    ...
    \only<2> {
        \includegraphics[width=0.85\textwidth]{zahlenstrahl_ordinal.jpeg}
    ...
    \only<3> {
        \includegraphics[width=\textwidth]{ordinal-omega-squared}
    ...
    \only<4> {
        \hspace{2cm}
        \includegraphics[height=0.8\textheight]{ordinal}
