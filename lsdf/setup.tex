...
% \usepackage[outputdir=\detokenize{~/Coding/things-to-talk-about/lsdf/out/}]{minted}
...
\titlegraphic{\vspace{3.8cm} \hspace{8.5cm} \includegraphics[height=2.5cm]{Logo_KIT}}
...
\begin{frame}[c]{What is the Large Scale Data Facility?}
    ...
    \includegraphics[width=0.4\textwidth,center]{LSDF_Logo}
    ...
    \end{itemize}
    % \includegraphics[width=0.4\textwidth,center]{storage1}
    \end{multicols}
\end{frame}
...
\begin{frame}[c]{Who am I?}
    \begin{multicols}{2}
        ...
        \end{itemize}
        \begin{figure}
        \includegraphics[height=0.75\textheight,center]{picture_self} \\
        \caption*{Felix Karg}
        \end{figure}
    \end{multicols}
\end{frame}
...
\newcommand{\pic}[2]{
\begin{frame}[c]{#1}
    \includegraphics[width=\textwidth,trim=0 0 0 3,clip]{Selection_0#2}
\end{frame}
}
