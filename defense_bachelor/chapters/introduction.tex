...
\begin{frame}[c]{Enhancer Promoter Interaction}
    ...
    \only<-1>{\includegraphics[scale=0.33, trim=0 650 0 0, clip]{Enhancer_Nucleotide_Sequence}}
    \only<2->{\includegraphics[scale=0.33, trim=0 70 0 580, clip]{Enhancer_Nucleotide_Sequence}}
