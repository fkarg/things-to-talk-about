...
\input{design.tex}    % IN PROGRESS
\input{focus.tex}   % IN PROGRESS
% \input{equality.tex} % IN PROGRESS % can not be shown .
\input{using_advantage.tex}   % IN PROGRESS
\input{dynamics.tex} % IN PROGRESS
\input{entropy.tex} % TODO
\input{nvidia.tex} % TODO
