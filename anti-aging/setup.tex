...
% \usepackage[style=alphabetic,maxnames=3,maxalphanames=5]{biblatex}
...
\usetheme[numbering=counter, progressbar=frametitle, subsectionpage=progressbar, block=fill]{metropolis}
...
\institute{Seminar Bioinformatics}
